...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_dist_vue_common_prod__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue/dist/vue.common.prod */ "./node_modules/vue/dist/vue.common.prod.js");
...
new vue_dist_vue_common_prod__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#solicitud',
  data: {
  ...
  methods: {
    ...
    getResultadoPendiente: function getResultadoPendiente() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/solicitud/datos/' + this.paginacionPendiente + '/' + this.usuario_id + '/pendiente?page=' + page).then(function (response) {
        ...
        toastr__WEBPACK_IMPORTED_MODULE_3___default.a.info('Solicitudes Cargadas Correctamente', {
          timeOut: 5000
        });
      });
    },
    ...
    postSolicitud: function postSolicitud() {
      var _this4 = this;

      var url = '/api/solicitud';
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(url, this.solicitud).then(function (response) {
        _this4.getResultadoPendiente();
