...
/* harmony import */ var vee_validate_dist_locale_es__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vee-validate/dist/locale/es */ "./node_modules/vee-validate/dist/locale/es.js");
/* harmony import */ var vee_validate_dist_locale_es__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(vee_validate_dist_locale_es__WEBPACK_IMPORTED_MODULE_5__);
...
vue_dist_vue_common_dev__WEBPACK_IMPORTED_MODULE_0___default.a.config.devtools = false;
vue_dist_vue_common_dev__WEBPACK_IMPORTED_MODULE_0___default.a.component('v-select', vue_select__WEBPACK_IMPORTED_MODULE_3___default.a);
vue_dist_vue_common_dev__WEBPACK_IMPORTED_MODULE_0___default.a.component('pagination', __webpack_require__(/*! laravel-vue-pagination */ "./node_modules/laravel-vue-pagination/dist/laravel-vue-pagination.common.js"));
vue_dist_vue_common_dev__WEBPACK_IMPORTED_MODULE_0___default.a.use(vee_validate__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
new vue_dist_vue_common_dev__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  watch: {
    ...
    selectFabricante: function selectFabricante() {
    ...
    selectFamilia: function selectFamilia() {
  ...
  methods: {
    ...
    getEspecialidades: function getEspecialidades() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (responce) {
        _this2.especialidades = responce.data;
      });
    },
    getProveedores: function getProveedores() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (responce) {
        _this3.proveedores = responce.data;
      });
    },
    getFabricantes: function getFabricantes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (responce) {
        _this4.fabricantes = responce.data;
      });
    },
    ...
    getsubfamilias: function getsubfamilias() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (responce) {
        _this6.subfamilias = responce.data;
      });
    },
    ...
    borrarCampos: function borrarCampos() {
      this.selectEspecialidad.Especialidad = null;
      this.selectEspecialidad.Descripcion = null;
    ...
    putArticulo: function putArticulo(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url).then(function (response) {
        if (response.data.serie == "MANUAL") {
          _this9.selectFabricante.FirmName = response.data.fabricante;
          _this9.selectFabricante.FirmCode = response.data.cod_fabricante;
          _this9.selectProveedor.CardName = response.data.proveedor;
          _this9.selectProveedor.CardCode = response.data.cod_proveedor;
        } else {
          _this9.proveedor = response.data.proveedor;
          _this9.fabricante = response.data.fabricante;
          _this9.cod_fabricante = response.data.cod_fabricante;
          _this9.cod_proveedor = response.data.cod_proveedor;
        }

        _this9.serie = response.data.serie;
        _this9.selectEspecialidad.Descripcion = response.data.especialidad;
        _this9.selectEspecialidad.Especialidad = response.data.cod_especialidad;
        _this9.selectFamilia.Familia = response.data.familia;
        _this9.selectSubfamilia.Subfamilia = response.data.subfamilia;
        _this9.medida = response.data.medida;
        _this9.cod_venta = response.data.cod_venta;
        _this9.cod_compra = response.data.cod_compra;
        _this9.descripcion = response.data.descripcion;
        _this9.comentarios = response.data.comentarios;
        _this9.detalle_id = response.data.id;

        _this9.getFamilias();

        _this9.getsubfamilias();
      });
    },
...
/***/ 0:
/*!************************************************!*\
  !*** multi ./resources/js/detalleSolicitud.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
