<div class="modal fade" id="editEstadoTarea"  tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <el-form :model="editEstadoTarea" label-width="120px" size="mini" :rules="rulesEstadoTarea" ref="editEstadoTareaForm">
                <div class="modal-body">
                    <el-form-item label="Titulo" prop="ESTADO_TAREA">
                        <el-input type="text" v-model="editEstadoTarea.ESTADO_TAREA"></el-input>
                    </el-form-item>
                    <el-form-item label="Icono" prop="ICON">
                        <el-input type="text" v-model="editEstadoTarea.ICON"></el-input>
                    </el-form-item>
                    <el-form-item label="Tipo" prop="COLOR">
                        <el-select v-model="editEstadoTarea.COLOR" placeholder="Seleccionar" style="width: 100%" clearable>
                    ...
                    <el-form-item label="Etiqueta" prop="TAG">
                        <el-select v-model="editEstadoTarea.TAG" placeholder="Seleccionar" style="width: 100%" clearable>
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <el-button size="small" type="primary" @click="handleUpdateEstadoTarea()">Actualizar</el-button>
