<div class="modal fade" id="editEstadoAccion"  tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <el-form :model="editEstadoAccion" label-width="120px" size="mini" :rules="rulesEstadoAccion" ref="editEstadoAccionForm">
                <div class="modal-body">
                    <el-form-item label="Titulo" prop="ACCION">
                        <el-input type="text" v-model="editEstadoAccion.ACCION"></el-input>
                    </el-form-item>
                    <el-form-item label="Icono" prop="ICON">
                        <el-input type="text" v-model="editEstadoAccion.ICON"></el-input>
                    </el-form-item>
                    <el-form-item label="Tipo" prop="COLOR">
                        <el-select v-model="editEstadoAccion.COLOR" placeholder="Seleccionar" style="width: 100%" clearable>
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <el-button size="small" type="primary" @click="handleUpdateEstadoAccion()">Actualizar</el-button>
