<div class="modal fade" id="modalHUB"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Lista de registros EDI 852 HUB</h4>
        </div>
        <div class="modal-body">
            <el-input v-model="search" placeholder="Buscar"></el-input>
             <el-table v-loading="loading" highlight-current-row height="430" :data="EDIHUB.filter(data => !search || data.ItemCode.toLowerCase().includes(search.toLowerCase()) || data.U_Cod_comp.toLowerCase().includes(search.toLowerCase()) || data.U_cat_id.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
