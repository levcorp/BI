    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <el-input v-model="search" placeholder="Buscar"></el-input>
             <el-table highlight-current-row height="430" :data="EDIHUB.filter(data => !search || data.ItemCode.toLowerCase().includes(search.toLowerCase()) || data.U_Cod_comp.toLowerCase().includes(search.toLowerCase()) || data.U_cat_id.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
