<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!-->
    ...
    * {
    ...
    <meta property="og:title" content="Tarea Finalizada" />
    </head>
    <!--[if mso]>
      <body class="mso">
    <![endif]-->
        ...
        <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ecf3f5;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
          <div role="banner">
            ...
            <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
              <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 14px;Margin-bottom: 31px;color: #c3ced9;font-family: Open Sans,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                <div class="logo-center" style="font-size:26px !important;line-height:32px !important;" align="center" id="emb-email-header"><a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #c3ced9;" href="https://bi.levcorp.bo">LEVCORP</a></div>
              </div>
            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
            </div>
          </div>
          ...
          <div style="background-color: #ffffff;">
            <div class="layout two-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
              ...
              <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #ffffff;"><td class="layout__edges">&nbsp;</td><td style="width: 300px" valign="top" class="w260"><![endif]-->
                <div class="column" style="Float: left;max-width: 320px;min-width: 300px; width: 320px;width: calc(12300px - 2000%);text-align: left;color: #757575;font-size: 14px;line-height: 21px;font-family: Roboto,Tahoma,sans-serif;">
          ...
          <div style="mso-line-height-rule: exactly;line-height: 20px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
              <img style="border: 0;display: block;height: auto;width: 100%;max-width: 221px;" alt="" width="221" src="{{asset('images/WIP-homepageV081-990000000003cf3c.png')}}" />
            </div>
          ...
          <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
            <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #557187;font-size: 16px;line-height: 26px;">TAREA {{strtoupper($tarea->TAREA)}} FINALIZADA</h3>
            <p style="Margin-top: 16px;Margin-bottom: 20px; font-size:12px;"><strong>Especialidad : </strong>{{ucwords($tarea->BRAND)}}</p>
            <p style="Margin-top: 16px;Margin-bottom: 20px; font-size:12px;"><strong>Sector : </strong>{{ucwords($tarea->SECTOR)}}</p>
            <p style="Margin-top: 16px;Margin-bottom: 20px; font-size:12px;"><strong>Fecha de Registro : </strong>{{ucwords(Date::parse($tarea->FECHA_REGISTRO)->format('l j F Y H:i:s'))}}</p>
            <p style="Margin-top: 16px;Margin-bottom: 20px; font-size:12px;"><strong>Fecha de Finalizacion : </strong>{{ucwords(Date::parse($tarea->FECHA_FINALIZACION)->format('l j F Y H:i:s'))}}</p>
            <p style="Margin-top: 16px;Margin-bottom: 20px; font-size:12px;"><strong>Descripción : </strong>{{ucwords($tarea->DESCRIPCION)}}</p>
          </div>
        </div>
                ...
                <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: Roboto,Tahoma,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    ...
                    <div style="font-size: 12px;line-height: 19px;">
                      <div>&#169; 2019 Levcorp. All rights reserved.</div>
                    </div>
