...
<head>
  ...
  <!--<![endif]-->
  <style type="text/css">
    body{background-color:#ecf3f5}
.logo a:focus,.logo a:hover{color:#859bb1!important}
.mso .layout-has-border{border-top:1px solid #a9c9d2;border-bottom:1px solid #a9c9d2}
.mso .layout-has-bottom-border{border-bottom:1px solid #a9c9d2}
.ie .border,.mso .border{background-color:#a9c9d2}
.ie h1,.mso h1{font-size:26px!important;line-height:34px!important}
.ie h2,.mso h2{font-size:20px!important;line-height:28px!important}
.mso .footer__share-button p{font-family:Roboto,Tahoma,sans-serif}
  </style>
          ...
          <div role="banner">
            <div class="preheader"
              ...
              <div style="border-collapse: collapse;display: table;width: 100%;">
                ...
                <div class="snippet"
                  style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 5px 0 5px 0;color: #b9b9b9;font-family: Roboto,Tahoma,sans-serif;">

                </div>
                <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
                <div class="webversion"
                  style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 5px 0 5px 0;text-align: right;color: #b9b9b9;font-family: Roboto,Tahoma,sans-serif;">
            ...
            <div class="header"
              ...
              <div class="logo emb-logo-margin-box"
                style="font-size: 26px;line-height: 32px;Margin-top: 5px;Margin-bottom: 15px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;"
                align="center">
                <div class="logo-center" style="font-size:26px !important;line-height:32px !important;" align="center"
                  id="emb-email-header"><a
                    style="text-decoration: none;transition: opacity 0.1s ease-in;color: #c3ced9;"
                    href="http://bi.levcorp.bo">LEVCORP</a></div>
              </div>
              <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
            </div>
          </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                      ...
                      <h4 style="font-size: 12px;Margin-top: 5px;Margin-bottom: 10px;">Total de registros generados:
                        <span
                          style="Margin-top: 5px;Margin-bottom: 10px; color:{{$count[0]['lp']==0 ? '#fe7575':'#557187'}};">
                          {{$count[0]['lp']}}</span></h4>
                    </div>
                  </div>
                ...
                <div class="column"
                  ...
                  <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                    <img style="border: 0;display: block;height: auto;width: 100%;max-width: 80px;" alt="" width="80"
                      src="{{$count[0]['lp']==0 ? asset('images/error.png'):asset('images/correct.png')}}" />
                  </div>
            ...
            <div class="layout two-col fixed-width"
              ...
              <div class="layout__inner"
                ...
                <div class="column"
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                      ...
                      <h4 style="font-size: 12px;Margin-top: 5px;Margin-bottom: 10px;">Total de registros generados:
                        <span
                          style="Margin-top: 5px;Margin-bottom: 10px; color:{{$count[0]['co']==0 ? '#fe7575':'#557187'}};">
                          {{$count[0]['co']}}</span></h4>
                    </div>
                  </div>
                ...
                <div class="column"
                  ...
                  <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                    <img style="border: 0;display: block;height: auto;width: 100%;max-width: 80px;" alt="" width="80"
                      src="{{$count[0]['co']==0 ? asset('images/error.png'):asset('images/correct.png')}}" />
                  </div>
            ...
            <div class="layout two-col fixed-width"
              ...
              <div class="layout__inner"
                ...
                <div class="column"
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                      ...
                      <h4 style="font-size: 12px;Margin-top: 5px;Margin-bottom: 10px;">Total de registros generados:
                        <span
                          style="Margin-top: 5px;Margin-bottom: 10px; color:{{$count[0]['sc']==0 ? '#fe7575':'#557187'}};">
                          {{$count[0]['sc']}}</span></h4>
                    </div>
                  </div>
                ...
                <div class="column"
                  ...
                  <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                    <img style="border: 0;display: block;height: auto;width: 100%;max-width: 80px;" alt="" width="80"
                      src="{{$count[0]['sc']==0 ? asset('images/error.png'):asset('images/correct.png')}}" />
                  </div>
