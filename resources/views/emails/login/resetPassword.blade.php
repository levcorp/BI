...
>
  ...
  <body
    class="clean-body"
    style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #F5F5F5;"
  >
        ...
        <tr style="vertical-align: top;" valign="top">
          ...
          >
                    ...
                    <div style="width:100% !important;">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p
                              style="font-size: 12px; line-height: 36px; margin: 0;"
                            >
                              <span style="font-size: 30px;"
                                ><strong
                                  ><span
                                    style="line-height: 36px; font-size: 30px;"
                                    >LEV<span
                                      style="line-height: 36px; font-size: 30px;"
                                      >CORP</span
                                    ></span
                  ...
                  >
                    <div style="width:100% !important;">
                      ...
                      >
                        ...
                        >
                          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 0px; padding-bottom: 10px; padding-left: 10px" align="right"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://bi.levcorp.bo" style="height:25.5pt; width:108.75pt; v-text-anchor:middle;" arcsize="42%" stroke="false" fillcolor="#e3edfe"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#052d3d; font-family:Tahoma, Verdana, sans-serif; font-size:12px"><!
                          [endif]--><a
                            href="https://bi.levcorp.bo"
            ...
            <div style="background-color:transparent;">
              ...
              >
                <div
                  style="border-collapse: collapse;display: table;width: 100%;background-color:#D6E7F0;"
                >
                  ...
                  >
                    <div style="width:100% !important;">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p
                              style="line-height: 42px; text-align: center; font-size: 12px; margin: 0;"
                            >
                              <span style="font-size: 28px;"
                                ><strong>Restablecer Contraseña</strong></span
                              >
                            </p>
                          </div>
                        </div>
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 18px; color: #000000;"
                                >Para cambiar la contraseña presione el
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 20px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$url}}" style="height:33pt; width:118.5pt; v-text-anchor:middle;" arcsize="35%" stroke="false" fillcolor="#fc7318"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:12px"><!
                          [endif]--><a
                            ...
                            target="_blank"
                            ><span
                              style="padding-left:40px;padding-right:40px;font-size:12px;display:inline-block;"
                              ><span style="font-size: 12px; line-height: 24px;"
                                >CONTINUAR</span
                              ></span
                            ></a
                      ...
                      >
                        ...
                        >
                          <tbody>
                            <tr style="vertical-align: top;" valign="top">
                              <td
                                style="word-break: break-word; vertical-align: top; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; border-collapse: collapse;"
                                valign="top"
                              >
                                <table
                                  activate="activate"
                                ...
                                >
                                  <tbody>
                                    ...
                                    >
                                      <td
                                        style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 8px; padding-left: 8px; border-collapse: collapse;"
                                        valign="top"
                                      >
                                        <a
                                          ...
                                          ><img
                                            alt="Facebook"
                                            height="32"
                                            src="{{asset('images/facebook@2x.png')}}"
                                      ...
                                      >
                                        <a
                                          ...
                                          ><img
                                            alt="Twitter"
                                            height="32"
                                            src="{{asset('images/twitter@2x.png')}}"
                                            style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; display: block;"
                                            title="Twitter"
                                            width="32"
                                        /></a>
                                      ...
                                      >
                                        <a
                                          ...
                                          ><img
                                            alt="Instagram"
                                            height="32"
                                            src="{{asset('images/instagram@2x.png')}}"
                                            style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; display: block;"
                                            title="Instagram"
                                            width="32"
                                        /></a>
                        ...
                        >
                          ...
                          >
                            <p
                              style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"
                            >
                              Levcorp | La Paz - Bolivia | 2782126
                            </p>
                            <p
                              style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"
                            >
                              Av. Roma N° 7447, Piso 2, Zona Obrajes
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
                        <div
                          style="color:#4F4F4F;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;"
                        >
                          <div
                            style="font-size: 12px; line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #4F4F4F;"
                          >
                            <p
                              style="font-size: 12px; line-height: 16px; text-align: center; margin: 0;"
                            >
                              <span style="font-size: 14px;"
                                >© 2019 Levcorp. All rights reserved.</span
                              >
                            </p>
                          </div>
                        </div>
