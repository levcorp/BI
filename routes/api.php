...
Route::get('rendicion/solicitudes/aprobado','Panel\controllerSolicitudRendicion@handleGetSolicitudesAprobado');
Route::get('rendicion/solicitudes/noaprobado','Panel\controllerSolicitudRendicion@handleGetSolicitudesNoAprobado');
Route::post('rendicion/solicitudes/aprobar','Panel\controllerSolicitudRendicion@handleAprobarSolicitud');
